...
int main() {
	...
	*/
	robot->_q << -M_PI*45/180, 0.15, M_PI*120/180; // Joint 1,2,3 Coordinates (radians, meters, radians)
	...
	*/
	...
	robot->Jv(ee_jacobian,ee_link_name,ee_pos_in_link); // Read Linear Jacobian into ee_jacobian
